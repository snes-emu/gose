...
func (cpu *CPU) registerIORegisters() {
	...
	cpu.ioRegisters[0x201] = io.NewRegister(nil, cpu.wrio, "WRIO")
	cpu.ioRegisters[0x202] = io.NewRegister(nil, cpu.wrmpya, "WRMPYA")
	cpu.ioRegisters[0x203] = io.NewRegister(nil, cpu.wrmpyb, "WRMPYB")
	cpu.ioRegisters[0x204] = io.NewRegister(nil, cpu.wrdivl, "WRDIVL")
	cpu.ioRegisters[0x205] = io.NewRegister(nil, cpu.wrdivh, "WRDIVH")
	cpu.ioRegisters[0x206] = io.NewRegister(nil, cpu.wrdivb, "WRDIVB")
	cpu.ioRegisters[0x207] = io.NewRegister(nil, cpu.htimel, "HTIMEL")
	cpu.ioRegisters[0x208] = io.NewRegister(nil, cpu.h0xtime, "H0XTIME")
	cpu.ioRegisters[0x209] = io.NewRegister(nil, cpu.vtimel, "VTIMEL")
	cpu.ioRegisters[0x20a] = io.NewRegister(nil, cpu.v0xtime, "V0XTIME")
	cpu.ioRegisters[0x20d] = io.NewRegister(nil, cpu.memsel, "MEMSEL")
	cpu.ioRegisters[0x210] = io.NewRegister(cpu.rdnmi, nil, "RDNMI")
	cpu.ioRegisters[0x211] = io.NewRegister(cpu.timeup, nil, "TIMEUP")
	cpu.ioRegisters[0x212] = io.NewRegister(cpu.hvbjoy, nil, "HVBJOY")
	cpu.ioRegisters[0x213] = io.NewRegister(cpu.rdio, nil, "RDIO")
	cpu.ioRegisters[0x214] = io.NewRegister(cpu.rddivl, nil, "RDDIVL")
	cpu.ioRegisters[0x215] = io.NewRegister(cpu.rddivh, nil, "RDDIVH")
	cpu.ioRegisters[0x216] = io.NewRegister(cpu.rdmpyl, nil, "RDMPYL")
	cpu.ioRegisters[0x217] = io.NewRegister(cpu.rdmpyh, nil, "RDMPYH")
	cpu.ioRegisters[0x218] = io.NewRegister(cpu.joy1l, nil, "JOY1L")
	cpu.ioRegisters[0x219] = io.NewRegister(cpu.joy1h, nil, "JOY1H")
	cpu.ioRegisters[0x21A] = io.NewRegister(cpu.joy2l, nil, "JOY2L")
	cpu.ioRegisters[0x21B] = io.NewRegister(cpu.joy2h, nil, "JOY2H")
	cpu.ioRegisters[0x21C] = io.NewRegister(cpu.joy3l, nil, "JOY3L")
	cpu.ioRegisters[0x21D] = io.NewRegister(cpu.joy3h, nil, "JOY3H")
	cpu.ioRegisters[0x21E] = io.NewRegister(cpu.joy4l, nil, "JOY4L")
	cpu.ioRegisters[0x21F] = io.NewRegister(cpu.joy4h, nil, "JOY4H")
}
